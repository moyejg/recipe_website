...
class DirectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create direction" do
    assert_difference('Direction.count') do
      post directions_url, params: { direction: { recipe_id: @direction.recipe_id, step_entry: @direction.step_entry } }
    end
  ...
  test "should update direction" do
    patch direction_url(@direction), params: { direction: { recipe_id: @direction.recipe_id, step_entry: @direction.step_entry } }
